...
const translations = {
  en: {
    hero: {
      badge: 'Local-first · Free forever',
      title: 'The time machine for AI coding',
      subtitle: 'Replay · Review · Keep it local',
      description: 'Map every Claude, Cursor, and Gemini conversation to each code change. Click any message to travel back to that moment in code—all local, redactable, optional encrypted sync.',
      downloadAlpha: 'Free Download Mantra',
      downloadSubline: 'macOS · Core features free forever · No sign-up',
      quickStart: 'Quick start in 3 min →',
      docs: 'Docs',
      messages: 'Messages',
      toolCalls: 'Tool Calls',
      tokens: 'Tokens',
      trustLine: 'Local-first · Time-travel replay · Multi-tool · Optional E2E Sync/Publish',
    },
    tools: {
    ...
    signup: {
      ...
      title: 'Stay in the',
      titleHighlight: 'Loop',
      subtitle: 'Product updates, tips, and community news — straight to your inbox.',
      placeholder: 'developer@example.com',
      alreadyRegistered: 'This email is already subscribed.',
      error: 'Something went wrong. Please try again.',
      networkError: 'Network error. Please check your connection.',
      serviceUnavailable: 'Service temporarily unavailable. Please try again later.',
      joining: 'Subscribing...',
      getEarlyAccess: 'Subscribe',
      noSpam: 'No spam. Just product updates and community news.',
      success: 'You\'re subscribed!',
      shareLink: 'Share your link to invite friends to the community.',
      referrals: 'referrals',
      code: 'Code',
      perks: 'Each referral helps grow our community and unlocks perks for you.',
      checkStatusTitle: 'Check Your Referral Status',
      checkStatusSubtitle: 'Already subscribed? View your referral count and link.',
      checkStatusPlaceholder: 'Enter your email',
      checkStatusButton: 'Check Status',
      checking: 'Checking...',
      notFound: 'Email not found. Subscribe above to get started!',
      yourStats: 'Your Referral Stats',
      signedUp: 'Subscribed',
      copy: 'Copy',
      copied: 'Copied!',
      // Community perks
      earlyBirdTitle: 'Community Perks',
      earlyBirdCondition: 'Subscribe + invite 3 friends',
      earlyBirdReward: 'Unlock Community Rewards',
      earlyBirdLimited: 'The more you share, the more you earn.',
      benefitsUnlock: 'Unlock these perks',
      benefitLifetime: 'Product Updates',
      benefitLifetimeDesc: 'First to know about new features, tips, and releases',
      benefitCommercial: 'Discord Insider',
      benefitCommercialDesc: 'Exclusive Discord role and access to private channels',
      benefitCommunity: 'Shape the Roadmap',
      benefitCommunityDesc: 'Your feedback directly influences what we build next',
    },
    header: {
      features: 'Features',
      mcpHub: 'MCP Hub',
  ...
  zh: {
    hero: {
      badge: '本地优先 · 永久免费',
      title: '让 AI 编程「可回放、可复盘」的本地时光机',
      subtitle: '回放 · 复盘 · 本地优先',
      description: '把你在 Claude、Cursor、Gemini 等工具里的对话，自动映射到每一次代码变更。点击任意一条消息，就像时间旅行一样回到当时的代码状态——全部本地保存，可脱敏，可选加密同步。',
      downloadAlpha: '免费下载 Mantra',
      downloadSubline: 'macOS · 核心功能永久免费 · 无需注册',
      quickStart: '3 分钟快速上手 →',
      docs: '文档',
      messages: '消息',
      toolCalls: '工具调用',
      tokens: 'Tokens',
      trustLine: '本地优先 · 时光旅行回放 · 支持多工具 · 可选端到端加密 Sync/Publish',
    },
    tools: {
      title: '一个应用，连接你的所有',
    ...
    signup: {
      ...
      title: '保持',
      titleHighlight: '同步',
      subtitle: '产品更新、使用技巧和社区动态，直达你的收件箱。',
      placeholder: 'developer@example.com',
      alreadyRegistered: '该邮箱已订阅。',
      error: '出了点问题，请重试。',
      networkError: '网络错误，请检查网络连接。',
      serviceUnavailable: '服务暂时不可用，请稍后重试。',
      joining: '订阅中...',
      getEarlyAccess: '订阅',
      noSpam: '无垃圾邮件。只有产品更新和社区动态。',
      success: '订阅成功！',
      shareLink: '分享链接，邀请朋友加入社区。',
      referrals: '次推荐',
      code: '邀请码',
      perks: '每次成功推荐都能壮大社区，你也能解锁更多权益。',
      checkStatusTitle: '查看推荐状态',
      checkStatusSubtitle: '已经订阅？查看你的推荐数量和链接。',
      checkStatusPlaceholder: '输入你的邮箱',
      checkStatusButton: '查看状态',
      checking: '查询中...',
      notFound: '未找到该邮箱。请先在上方订阅！',
      yourStats: '你的推荐统计',
      signedUp: '订阅时间',
      copy: '复制',
      copied: '已复制！',
      // 社区权益
      earlyBirdTitle: '社区权益',
      earlyBirdCondition: '订阅 + 邀请 3 位好友',
      earlyBirdReward: '解锁社区奖励',
      earlyBirdLimited: '分享越多，收获越多。',
      benefitsUnlock: '达成条件即可获得',
      benefitLifetime: '产品动态',
      benefitLifetimeDesc: '第一时间获取功能更新、使用技巧和发版资讯',
      benefitCommercial: 'Discord 特权',
      benefitCommercialDesc: '专属 Discord 角色和私密频道访问权限',
      benefitCommunity: '影响路线图',
      benefitCommunityDesc: '你的反馈直接影响我们下一步做什么',
    },
    header: {
      features: '功能',
      mcpHub: 'MCP Hub',
